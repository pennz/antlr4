...
type CPP14Listener interface {
	...
	// EnterTypeidofexpr is called when entering the typeidofexpr production.
	EnterTypeidofexpr(c *TypeidofexprContext)
	...
	// ExitTypeidofexpr is called when exiting the typeidofexpr production.
	ExitTypeidofexpr(c *TypeidofexprContext)
