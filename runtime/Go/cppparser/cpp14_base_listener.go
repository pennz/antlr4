...
// EnterTypeidofexpr is called when production typeidofexpr is entered.
func (s *BaseCPP14Listener) EnterTypeidofexpr(ctx *TypeidofexprContext) {}

// ExitTypeidofexpr is called when production typeidofexpr is exited.
func (s *BaseCPP14Listener) ExitTypeidofexpr(ctx *TypeidofexprContext) {}

// EnterTypeidofthetypeid is called when production typeidofthetypeid is entered.
func (s *BaseCPP14Listener) EnterTypeidofthetypeid(ctx *TypeidofthetypeidContext) {}

// ExitTypeidofthetypeid is called when production typeidofthetypeid is exited.
func (s *BaseCPP14Listener) ExitTypeidofthetypeid(ctx *TypeidofthetypeidContext) {}
...
func (s *BaseCPP14Listener) EnterShiftoperator(ctx *ShiftoperatorContext) {}

// ExitShiftoperator is called when production shiftoperator is exited.
func (s *BaseCPP14Listener) ExitShiftoperator(ctx *ShiftoperatorContext) {}
